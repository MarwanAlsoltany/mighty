...
/**
 * Adds `datetime.lte` rule. Asserts that the input is a datetime string/object less than (before) or equal to the given datetime string.
 *
...
final class DatetimeLte extends Rule
{
    public const NAME = 'datetime.lte';

    public function __construct(string $datetime, ?string $message = null, Strategy $strategy = Strategy::FailLazy)
    {
