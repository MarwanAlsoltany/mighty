...
final class ImageWidthGte extends Rule
{
    public const NAME = 'image.width.gte';

    public function __construct(int $width, ?string $message = null, Strategy $strategy = Strategy::FailLazy)
    {
