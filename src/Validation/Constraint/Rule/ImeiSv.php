...
/**
 * Adds `imei.sv` rule. Asserts that the input is a valid IMEI-SV (International Mobile Station Equipment Identity and Software Version Number).
 *
...
final class ImeiSv extends Rule
{
    public const NAME = 'imei.sv';
