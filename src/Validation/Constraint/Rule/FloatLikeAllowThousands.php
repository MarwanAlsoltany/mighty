...
final class FloatLikeAllowThousands extends Rule
{
    public const NAME = 'floatLike.allowThousands';

    public function __construct(float $min = PHP_FLOAT_MIN, float $max = PHP_FLOAT_MAX, ?string $message = null, Strategy $strategy = Strategy::FailLazy)
    {
