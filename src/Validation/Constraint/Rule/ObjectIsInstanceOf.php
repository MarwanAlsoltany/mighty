...
final class ObjectIsInstanceOf extends Rule
{
    public const NAME = 'object.isInstanceOf';

    public function __construct(string $classFQN, ?string $message = null, Strategy $strategy = Strategy::FailLazy)
    {
