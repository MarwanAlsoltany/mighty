...
final class FileDirname extends Rule
{
    public const NAME = 'file.dirname';

    public function __construct(string $dirname, ?string $message = null, Strategy $strategy = Strategy::FailLazy)
    {
