...
final class StringLength extends Rule
{
    public const NAME = 'string.length';

    public function __construct(int $length, ?string $message = null, Strategy $strategy = Strategy::FailLazy)
    {
