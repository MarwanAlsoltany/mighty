...
final class FileSizeGte extends Rule
{
    public const NAME = 'file.size.gte';

    public function __construct(int $sizeInBytes, ?string $message = null, Strategy $strategy = Strategy::FailLazy)
    {
