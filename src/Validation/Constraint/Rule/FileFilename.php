...
final class FileFilename extends Rule
{
    public const NAME = 'file.filename';

    public function __construct(string $filename, ?string $message = null, Strategy $strategy = Strategy::FailLazy)
    {
