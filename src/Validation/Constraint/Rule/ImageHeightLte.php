...
final class ImageHeightLte extends Rule
{
    public const NAME = 'image.height.lte';

    public function __construct(int $height, ?string $message = null, Strategy $strategy = Strategy::FailLazy)
    {
