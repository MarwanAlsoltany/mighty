...
/**
 * Adds `currency.name` rule. Asserts that the input is a valid currency name (as in ISO 4217).
 *
...
final class CurrencyName extends Rule
{
    public const NAME = 'currency.name';
