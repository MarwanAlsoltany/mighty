...
/**
 * Adds `email.withUnicode` rule. Asserts that the input is an email address (unicode allowed).
 *
...
final class EmailWithUnicode extends Rule
{
    public const NAME = 'email.withUnicode';
