...
/**
 * Adds `object.isStringable` rule. Asserts that the input implements __toString() method.
 *
...
final class ObjectIsStringable extends Rule
{
    public const NAME = 'object.isStringable';
