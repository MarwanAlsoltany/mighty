...
final class FileBasename extends Rule
{
    public const NAME = 'file.basename';

    public function __construct(string $basename, ?string $message = null, Strategy $strategy = Strategy::FailLazy)
    {
