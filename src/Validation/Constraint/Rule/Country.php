...
/**
 * Adds `country` rule. Asserts that the input is a valid country code (default: "ISO 3166-1 alpha-2"; long: "ISO 3166-1 alpha-3").
 *
...
final class Country extends Rule
{
    public const NAME = 'country';

    public function __construct(bool $long = false, ?string $message = null, Strategy $strategy = Strategy::FailLazy)
    {
