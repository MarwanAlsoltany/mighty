...
/**
 * Adds `isin` rule. Asserts that the input is a valid ISIN (International Securities Identification Number).
 *
...
final class Isin extends Rule
{
    public const NAME = 'isin';
