...
final class ArrayHasDistinct extends Rule
{
    public const NAME = 'array.hasDistinct';

    public function __construct(string|int $key, ?string $message = null, Strategy $strategy = Strategy::FailLazy)
    {
