...
/**
 * Adds `calender.day` rule. Asserts that the input looks like a calendar dayin shot or long format ("Mon" or "Monday").
 *
...
final class CalenderDay extends Rule
{
    public const NAME = 'calender.day';
