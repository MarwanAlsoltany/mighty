...
final class ImageDimensions extends Rule
{
    public const NAME = 'image.dimensions';

    public function __construct(int $width, int $height, string $operator = '==', ?string $message = null, Strategy $strategy = Strategy::FailLazy)
    {
