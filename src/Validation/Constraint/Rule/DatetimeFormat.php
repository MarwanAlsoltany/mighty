...
final class DatetimeFormat extends Rule
{
    public const NAME = 'datetime.format';

    public function __construct(string $format, ?string $message = null, Strategy $strategy = Strategy::FailLazy)
    {
