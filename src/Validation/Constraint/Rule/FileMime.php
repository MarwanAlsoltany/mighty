...
final class FileMime extends Rule
{
    public const NAME = 'file.mime';

    public function __construct(string|array $mine, ?string $message = null, Strategy $strategy = Strategy::FailLazy)
    {
