...
/**
 * Adds `image.ratio` rule. Asserts that the input is an image and its aspect ratio is equal to the given ratio (ratio must be specified like "16:9").
 *
...
final class ImageRatio extends Rule
{
    public const NAME = 'image.ratio';

    public function __construct(string $ratio, ?string $message = null, Strategy $strategy = Strategy::FailLazy)
    {
