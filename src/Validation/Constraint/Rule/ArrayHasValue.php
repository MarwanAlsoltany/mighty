...
final class ArrayHasValue extends Rule
{
    public const NAME = 'array.hasValue';

    public function __construct(mixed $value, ?string $message = null, Strategy $strategy = Strategy::FailLazy)
    {
