...
final class IntegerLikeAllowOctal extends Rule
{
    public const NAME = 'integerLike.allowOctal';

    public function __construct(int $min = PHP_INT_MIN, int $max = PHP_INT_MAX, ?string $message = null, Strategy $strategy = Strategy::FailLazy)
    {
