...
final class ObjectHasProperty extends Rule
{
    public const NAME = 'object.hasProperty';

    public function __construct(string $property, ?string $message = null, Strategy $strategy = Strategy::FailLazy)
    {
