...
final class FileExtension extends Rule
{
    public const NAME = 'file.extension';

    public function __construct(string $extension, ?string $message = null, Strategy $strategy = Strategy::FailLazy)
    {
