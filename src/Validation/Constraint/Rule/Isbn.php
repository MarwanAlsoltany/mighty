...
/**
 * Adds `isbn` rule. Asserts that the input is a valid ISBN (International Standard Book Number). The type (10/13) can be specifed to narrow the pattern.
 *
...
final class Isbn extends Rule
{
    public const NAME = 'isbn';

    public function __construct(string|int|null $type = null, ?string $message = null, Strategy $strategy = Strategy::FailLazy)
    {
