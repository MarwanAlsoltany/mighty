...
/**
 * Adds `currency` rule. Asserts that the input is a valid currency code (default: "ISO 4217 alpha"; numeric: "ISO 4217 numeric").
 *
...
final class Currency extends Rule
{
    public const NAME = 'currency';

    public function __construct(bool $numeric = false, ?string $message = null, Strategy $strategy = Strategy::FailLazy)
    {
