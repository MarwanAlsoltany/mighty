...
/**
 * Adds `datetime.gt` rule. Asserts that the input is a datetime string/object greater than (after) the given datetime string.
 *
...
final class DatetimeGt extends Rule
{
    public const NAME = 'datetime.gt';
