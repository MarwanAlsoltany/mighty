...
/**
 * Adds `type.debug` rule. Asserts that the input is of the given type using get_debug_type().
 *
...
final class TypeDebug extends Rule
{
    public const NAME = 'type.debug';

    public function __construct(string $type, ?string $message = null, Strategy $strategy = Strategy::FailLazy)
    {
