...
final class Regexp extends Rule
{
    public const NAME = 'regexp';

    public function __construct(string $pattern, ?string $message = null, Strategy $strategy = Strategy::FailLazy)
    {
