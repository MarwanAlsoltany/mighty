...
/**
 * Adds `graph` rule. Asserts that the input consists of graphic characters only (characters that create a visible output).
 *
...
final class Graph extends Rule
{
    public const NAME = 'graph';
