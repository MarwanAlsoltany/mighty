...
/**
 * Adds `allowed` rule. Asserts that the input is allowed (can be empty or have any value, null and empty string are considered valid values).
 *
...
final class Allowed extends Rule
{
    public const NAME = 'allowed';
