...
/**
 * Adds `imei` rule. Asserts that the input is a valid IMEI (International Mobile Station Equipment Identity Number).
 *
...
final class Imei extends Rule
{
    public const NAME = 'imei';
