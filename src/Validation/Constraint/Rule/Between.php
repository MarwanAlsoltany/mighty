...
/**
 * Adds `between` rule. Asserts that the input count is between the given values. Works with all data types (null: 0; boolean: 0 or 1; float/integer: number value; string: characters count; array/countable: elements count; object: accessible properties count).
 *
...
final class Between extends Rule
{
    ...
    public function __construct(int|float $min, int|float $max, ?string $message = null, Strategy $strategy = Strategy::FailLazy)
    {
